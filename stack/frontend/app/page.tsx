...
import { LeaderboardCard, RewardVaultCard } from "@/components/LeaderboardRewardCards";
import { GrowthReportCard } from "@/components/GrowthReportCard";
import { ShareCard } from "@/components/ShareCard";
import { OnboardingFlow, useOnboarding } from "@/components/OnboardingFlow";
import { useToast } from "@/components/Toast";
import { CONTRACTS, NETWORK, explorerTx } from "@/lib/contracts";

const TABS = ["Log", "AI", "Report", "History", "Proofs", "Goals", "Profile", "Streak", "Identity", "Wellness", "Export", "Rewards", "Share"] as const;
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {tab === "Report"   && <GrowthReportCard />}
          {tab === "Proofs"   && <ProofsTab />}
          {tab === "Goals"    && <GoalTrackerCard />}
